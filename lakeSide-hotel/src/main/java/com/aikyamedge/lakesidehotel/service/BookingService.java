...
import com.aikyamedge.lakesidehotel.repository.BookingRepository;
...
public class BookingService implements IBookingService {
    ...
    public String saveBooking(Long roomId, BookedRoom bookingRequest) {
        ...
        if(roomIsAvailable){
            ...
            throw new InvalidBookingRequestException("Sorry, This room his not available for selected dates;");
        }
